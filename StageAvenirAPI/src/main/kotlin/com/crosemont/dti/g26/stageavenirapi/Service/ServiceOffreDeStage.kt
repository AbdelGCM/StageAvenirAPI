...
class ServiceOffreDeStage(val dao: OffreStageDAO){
    ...
    //Candidatures
    fun postulerPourUneOffre (codeEtudiant : Int ,codeOffre:Int, candidature: Candidature){



    }
    fun obtenirCandidaturesParEtudiant (codeEtudian:Int){}
    fun obtenirCandidaturesParOffreStage (codeEtudian:Int){}
