...
-- Mon Dec 11 23:32:58 2023
-- Model: New Model    Version: 1.0
-- MySQL Workbench Forward Engineering

-- -----------------------------------------------------
-- Schema stageavenirapi
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `offreStage` (
  ...
  INDEX `fk_offreStage_utilisateur1_idx` (`utilisateur_idutilisateur` ASC) VISIBLE,
  INDEX `fk_offreStage_categorie1_idx` (`categorie_idcategorie` ASC) VISIBLE,
  CONSTRAINT `fk_offreStage_utilisateur1`
    FOREIGN KEY (`utilisateur_idutilisateur`)
    REFERENCES `stageavenirapi`.`utilisateur` (`idutilisateur`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
